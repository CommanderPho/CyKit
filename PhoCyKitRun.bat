...
@REM @REM CALL C:\Users\pho\Anaconda2\Scripts\activate.bat C:\Users\pho\Anaconda2\envs\CyKit-AnacondaPython36
@REM cd C:\Users\pho\bin\CyKit-master\Py3\
@REM @REM REM Python.exe C:\Users\pho\bin\CyKit-master\Py3\CyKIT.py 127.0.0.1 5555 2 openvibe+nocounter+noheader+nobattery+ovdelay:100+float+ovsamples:004
